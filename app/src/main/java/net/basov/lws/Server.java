...
class Server extends Thread {
    ...
    private final String ipAddres;
    private static Handler mHandler;
    private final Context context;

    private static final LinkedList<Socket> clientList = new LinkedList<>();

    public Server(Handler handler, String documentRoot, String ip, int port, Context context, String title, String ipAddres) throws IOException {
        super();
    ...
    public void run() {
        while( running ) {
            try {
                ...
                new ServerHandler(documentRoot, context, client, Server.mHandler, this.title, this.ipAddres).start();
